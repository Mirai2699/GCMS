<div aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="add_educ_rec" class="modal fade">
     <div class="modal-dialog" style="width: 1000px; ">
         <div class="modal-content" >
             <div class="modal-header" style="background-color: #00acc1">
                 <h5 class="modal-title" style="font-size: 25px; color: white; text-align: center ">Setup Education and Schooling Information Details
                                       ...
                                       <div class="col-md-12" style="margin-top: 20px; margin-right: 30px">
                                           ...
                                           <div style="overflow:auto;">
                                             <div style="float:right;">
                                               <button type="submit" class="btn btn-primary" name="add_educ_rec" style="margin:5px">
