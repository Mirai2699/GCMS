            ...
            <div class="row" style="margin-bottom: 15px">
                <div class="col-md-12" style="background-color: #6e6e6e">
                    <ul class="breadcrumbs-alt" style="margin-top: 8px">
                        ...
                        <li>
                            <a class="current" href="semester.php">Setup Semesters</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <form role="form" action="../functionalities/insert_func.php" method="POST">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" style="color: black" name="sem_desc" placeholder="Enter Semester" required>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                        <button type="submit" class="btn btn-info" name="add_sem" style="margin-top: 23px">
                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                <table  class="display table table-bordered table-striped" id="dynamic-table">
                                    <thead>
                                    <tr>
                                        <th style="display: none">Sem ID</th>
                                    ...
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($view_query))
                                        {
                                            ...
                                            $sem_add_date = $row["sem_add_date"];
                                            $sem_mod_date = $row["sem_mod_date"];
                                            $sem_active_flag = $row["sem_active_flag"];
                                                        
                                    ?>      
                                        <tr class="gradeX">
                                            <td style="display: none"><?php echo $ID; ?></td>
                                            <td width=""><?php echo $sem_desc; ?></td>
                                            <td width=""><?php echo $sem_mod_date; ?></td>
                                            <td width=""><?php echo $sem_active_flag; ?></td>
                                            <td style='width:12%'>
                                                <center>
                            ...
                            <center>
                                ...
                                <div class="modal-body" style="height:140px;">
                                   <form role="form" action="../functionalities/update_func.php" method="POST">
                                        <input type="hidden" name="sem_ID"  value="<?php echo $ID?>">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Document Type Description</label>
                                                    <input type="text" class="form-control" style="color: black" name="sem_desc" placeholder="Enter Semester Description" required value="<?php echo $sem_desc?>">
                                                </div>
                                            </div>
                                        <div class="col-md-12" style="text-align: center">
                                                <button type="submit" class="btn btn-info" name="edit_sem" style="margin-top: 4px">
                                                        <i class="fa fa-save"></i>
                                                        Save
                                                </button>
                                ...
                                <div class="modal-body" style="height:150px;">
                                    ...
                                    <form action="../functionalities/archive_func.php" method="POST">
                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <button type="submit" name="arch_sem" class="btn btn-success" style="font-size: 21px">
