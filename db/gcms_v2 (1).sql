...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2019 at 02:07 PM
...
--
-- Dumping data for table `t_stud_honors_awards`
--

INSERT INTO `t_stud_honors_awards` (`hon_ID`, `hon_student`, `hon_school`, `hon_received_type`, `hon_description`, `hon_add_date`, `hon_mod_date`, `hon_active_flag`) VALUES
(4, '2015-00193-CM-0', 2, 'Honors', '3rd Honors', '2019-01-09 13:41:11', '2019-01-09 13:41:11', 'Show'),
(5, '2015-00193-CM-0', 3, 'Award', 'Most Punctual', '2019-01-09 14:28:59', '2019-01-09 14:28:59', 'Show');
...
--
ALTER TABLE `t_stud_honors_awards`
  MODIFY `hon_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `t_stud_visitation`
  MODIFY `vs_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
